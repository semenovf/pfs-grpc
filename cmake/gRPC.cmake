...
if (EXISTS "${CMAKE_SOURCE_DIR}/3rdparty/grpc/CMakeLists.txt")
    set(pfs_GRPC_SOURCE_ROOT_DIR "${CMAKE_SOURCE_DIR}/3rdparty/grpc")
    set(pfs_GRPC_BINARY_ROOT_DIR "${CMAKE_BINARY_DIR}/3rdparty/grpc")
else()
    set(pfs_GRPC_SOURCE_ROOT_DIR "${CMAKE_SOURCE_DIR}/3rdparty/preloaded/grpc")
    set(pfs_GRPC_BINARY_ROOT_DIR "${CMAKE_BINARY_DIR}/3rdparty/preloaded/grpc")
endif()

set(pfs_PROTOBUF_INPUT_DIRECTORY ${PROTOBUF_INPUT_DIRECTORY})
set(pfs_PROTOC_BIN "${pfs_GRPC_BINARY_ROOT_DIR}/third_party/protobuf/protoc")
set(pfs_GRPC_CPP_PLUGIN_PATH "${pfs_GRPC_BINARY_ROOT_DIR}/grpc_cpp_plugin")
...
set(pfs_GRPC_INCLUDE_DIRS
    ${pfs_GRPC_SOURCE_ROOT_DIR}/include
    ${pfs_GRPC_SOURCE_ROOT_DIR}/third_party/protobuf/src
